...
INCSTRING
    ...
    GOTO I2CSEND    ; SHOULD NOT BE HIT 
...
VALIDE
    ...
    MOVFW PBYTE
    SUBWF EMAX,0
    BTFSC STATUS,C  ; IF RESULT IT GREATER THAN MOVE TO A STRING
    RLF LASTADD,1   
    GOTO I2CSEND
...
VALIDA
    MOVFW PBYTE
    SUBWF AMAX,0
    BTFSC STATUS,C  ; IF OUT OF BOUNDS OF A STRING MOVE TO D STRING
    RLF LASTADD,1
    GOTO I2CSEND
...
VALIDD
    MOVFW PBYTE
    SUBWF DMAX,0
    BTFSC STATUS,C  ; IF OUT OF BOUNDS OF D STRING MOVE TO G STRING
    RLF LASTADD,1
    GOTO I2CSEND
...
DOWNG
    ...
    SUBWF PBYTE,0
    BTFSS STATUS,C
    RLF LASTADD,1	; IF NOTE IS LOWER THAN G MIN MOVE TO D STRING
    GOTO I2CSEND	
