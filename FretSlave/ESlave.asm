...
D_OFFSET
    MOVLW H'00A'    
    SUBWF PITCH,1   ; SUBTRACT THE 10 NOTE OFFSET FOR A STRING
    GOTO FRETSELECT
    
G_OFFSET
    MOVLW H'00F'
    SUBWF PITCH,1   ; SUBTRACT THE 15 NOTE OFFSET FOR A STRING
    GOTO FRETSELECT
...
PORT_B_SET
    BANKSEL PORTA	
    MOVLW H'01B'
    SUBWF PITCH,0	; REDUCE MIDI BY OFFSET TO GET 0X00 TO 0X08 STORE W
    MOVWF TEMP
    CALL Hex_To_One
...
PORT_A_SET
    BANKSEL PORTA
    MOVLW H'024'    
    SUBWF PITCH,0	; REDUCE MIDI TO GET 0X00 TO 0X05
    MOVWF TEMP
    CALL Hex_To_One
    MOVWF PORTA		
    RETURN
